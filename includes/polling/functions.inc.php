...
function poll_wireless_sensor($device, $class)
{
    global $graphs;
    ...
    foreach ($sensors as $sensor) {
        ...
        } elseif ($sensor['sensor_aggregator'] == 'sum') {
...
//            // FIXME Check for alerts and also warn when crossing WARN level!
...
//            }
        ...
        $rrd_name = array('wireless-sensor', $sensor['sensor_class'], $sensor['sensor_type'], $sensor['sensor_index']);
